...
x_cols = base_cols + vill_cols + weather_monthly + weather_seasonal
y_col = 'work_us'
...
importance_df.to_csv(f'{out_dir}/logistic_w_feature_importance.csv', index=False)

plt.figure(figsize=(12,6))
sns.barplot(data=importance_df.head(20), x='importance', y='feature')
plt.title('Top 20 Most Important Features (|coef|)')
plt.tight_layout()
plt.savefig(f'{out_dir}/logistic_w_feature_importance.png')
plt.close()
...
plt.tight_layout()
plt.savefig(f'{out_dir}/logistic_w_confusion_matrix.png')
plt.close()
